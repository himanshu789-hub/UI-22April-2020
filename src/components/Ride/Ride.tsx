...
import { BookingStatus, VehicleType, Discount } from '../../constant/enums';
import IOfferDTO, { OfferDTO } from '../../models/Offerring';
...
import ILocationDTO,{LocationDTO} from '../../models/Location';
...
import IAutoSuggestService from './../../services/AutoSuggestService';
import ILocationService from '../../services/LocationService';
import {IBookingRequestInfo} from './../../interfaces/interfaces';
